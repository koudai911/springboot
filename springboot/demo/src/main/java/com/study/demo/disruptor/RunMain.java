package com.study.demo.disruptor;
...
import com.study.demo.disruptor.handler.MyParkingDataInDbHandler;
import com.study.demo.disruptor.handler.MyParkingDataSmsHandler;
import com.study.demo.disruptor.handler.MyParkingDataToKafkaHandler;
import com.study.demo.disruptor.producer.MyInParkingDataEventPublisher;
...
public class RunMain {
    public static void main(String[] args) {
        ...
        try {
            ...
            CountDownLatch countDownLatch = new CountDownLatch(MyInParkingDataEventPublisher.NUM);
            // 生产者生成数据
